<svg width="1180" height="610" viewBox="0 0 1180 610" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs>
    <clipPath id="canvasClip-dark">
      <rect x="0" y="0" width="1180" height="610" rx="24"/>
    </clipPath>
    <clipPath id="leftClip-dark">
  ...
  <g clip-path="url(#canvasClip-dark)">
    ...
    </circle><circle cx="157" cy="217" r="2" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="254" cy="354" r="3" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="351" cy="491" r="1" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="448" cy="118" r="2" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="545" cy="255" r="3" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="642" cy="392" r="1" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="739" cy="529" r="2" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="836" cy="156" r="3" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="933" cy="293" r="1" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="1030" cy="430" r="2" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="1127" cy="567" r="3" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="84" cy="194" r="1" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="181" cy="331" r="2" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="278" cy="468" r="3" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="375" cy="95" r="1" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="472" cy="232" r="2" fill="#22D3EE" opacity="0.5">
    ...
    </circle><circle cx="569" cy="369" r="3" fill="#22D3EE" opacity="0.5">
    ...
    <!-- divider -->
    <line x1="448" y1="30" x2="448" y2="580" stroke="url(#accentGrad-dark)" stroke-opacity="0.25" stroke-width="1"/>

    <!-- LEFT PANEL -->
    <g clip-path="url(#leftClip-dark)">
      <rect x="0" y="0" width="448" height="610" fill="#0F172A" fill-opacity="0.72"/>

      <text x="40" y="58" font-family="'JetBrains Mono',monospace" font-size="12" fill="#94A3B8" opacity="0">
      ...
      <text x="40" y="96" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="0.5s" dur="0.4s" fill="freeze"/>              ......
      </text>
      <text x="40" y="111" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="0.59s" dur="0.4s" fill="freeze"/>          ...::::::::...
      </text>
      <text x="40" y="126" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="0.68s" dur="0.4s" fill="freeze"/>        ..::----------::..
      </text>
      <text x="40" y="141" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="0.77s" dur="0.4s" fill="freeze"/>       .::--====++====--::.
      </text>
      <text x="40" y="156" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="0.86s" dur="0.4s" fill="freeze"/>      .::--=+++****+++=--::.
      </text>
      <text x="40" y="171" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="0.95s" dur="0.4s" fill="freeze"/>     ..:--=++**####**++=--:..
      </text>
      <text x="40" y="186" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="1.04s" dur="0.4s" fill="freeze"/>     ..:--=++*##%%##*++=--:..
      </text>
      <text x="40" y="201" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="1.13s" dur="0.4s" fill="freeze"/>     ..:--=++**####**++=--:..
      </text>
      <text x="40" y="216" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="1.22s" dur="0.4s" fill="freeze"/>      .::--=+++****+++=--::.
      </text>
      <text x="40" y="231" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="1.31s" dur="0.4s" fill="freeze"/>       .::--====++====--::.
      </text>
      <text x="40" y="246" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="1.4s" dur="0.4s" fill="freeze"/>        ..::----------::..
      </text>
      <text x="40" y="261" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="1.49s" dur="0.4s" fill="freeze"/>          ...::::::::...
      </text>
      <text x="40" y="276" font-family="'JetBrains Mono','Consolas',monospace" font-size="11" letter-spacing="1" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="1.58s" dur="0.4s" fill="freeze"/>              ......
      </text>
      </g>

      <rect x="40" y="297" width="8" height="12" fill="url(#asciiGrad-dark)" opacity="0">
        <animate attributeName="opacity" begin="1.97s" dur="1s" values="1;0;1" repeatCount="indefinite"/>
      </rect>

      <text x="40" y="331" font-family="'JetBrains Mono',monospace" font-size="14" font-weight="700" fill="url(#accentGrad-dark)" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="2.27" dur="0.5s" fill="freeze"/>
        Ketan_Patil.dev
      </text>

      <!-- scanline -->
      <rect x="0" y="0" width="448" height="3" fill="#22D3EE" opacity="0.12">
    ...
    <g>
      ...
      <rect x="488" y="36" width="652" height="40" rx="10" fill="#FFFFFF" fill-opacity="0.06" stroke="#FFFFFF" stroke-opacity="0.08"/>
      <circle cx="512" cy="56" r="5.5" fill="#EF4444" opacity="0.9"/>
      <circle cx="532" cy="56" r="5.5" fill="#F59E0B" opacity="0.9"/>
      <circle cx="552" cy="56" r="5.5" fill="#10B981" opacity="0.9"/>
      <text x="814.0" y="60" text-anchor="middle" font-family="'JetBrains Mono',monospace" font-size="12" fill="#94A3B8">ketan@dev:~</text>

      <text x="544" y="140" font-family="'Inter',sans-serif" font-size="20" fill="#94A3B8" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="0.2s" dur="0.5s" fill="freeze"/>
        Hi
      </text>
      <text x="544" y="180" font-family="'Inter',sans-serif" font-size="38" font-weight="800" fill="#F8FAFC" opacity="0">
        <animate attributeName="opacity" from="0" to="1" begin="0.5s" dur="0.6s" fill="freeze"/>
        I'm <tspan fill="url(#accentGrad-dark)">Ketan Patil</tspan>
      </text>
      ...
      <g opacity="0">
        ...
        <g clip-path="url(#clipRoledark0)">
          <text x="544" y="205" font-family="'JetBrains Mono','Consolas',monospace" font-size="21" font-weight="600" fill="url(#accentGrad-dark)">Full Stack Web Developer</text>
        </g>
      </g>
      <g opacity="0">
        <animate attributeName="opacity" begin="0s" dur="15.0s" repeatCount="indefinite"
        ...
        <g clip-path="url(#clipRoledark1)">
          <text x="544" y="205" font-family="'JetBrains Mono','Consolas',monospace" font-size="21" font-weight="600" fill="url(#accentGrad-dark)">PHP &amp; CodeIgniter 4 Specialist</text>
        </g>
      </g>
      <g opacity="0">
        <animate attributeName="opacity" begin="0s" dur="15.0s" repeatCount="indefinite"
        ...
        <g clip-path="url(#clipRoledark2)">
          <text x="544" y="205" font-family="'JetBrains Mono','Consolas',monospace" font-size="21" font-weight="600" fill="url(#accentGrad-dark)">React.js Developer</text>
        </g>
      </g>
      <g opacity="0">
        <animate attributeName="opacity" begin="0s" dur="15.0s" repeatCount="indefinite"
        ...
        <g clip-path="url(#clipRoledark3)">
          <text x="544" y="205" font-family="'JetBrains Mono','Consolas',monospace" font-size="21" font-weight="600" fill="url(#accentGrad-dark)">UI Engineer</text>
        </g>
      </g>
      <g opacity="0">
        <animate attributeName="opacity" begin="0s" dur="15.0s" repeatCount="indefinite"
        ...
        <g clip-path="url(#clipRoledark4)">
          <text x="544" y="205" font-family="'JetBrains Mono','Consolas',monospace" font-size="21" font-weight="600" fill="url(#accentGrad-dark)">Open Source Enthusiast</text>
        </g>
      </g>
      
      <rect x="544" y="186" width="3" height="24" fill="url(#accentGrad-dark)">
      ...
      <g opacity="0" transform="translate(-10,0)">
        ...
        <rect x="544" y="244" width="34" height="18" rx="5" fill="url(#accentGrad-dark)" opacity="0.16"/>
        <text x="561" y="257" text-anchor="middle" font-family="'JetBrains Mono',monospace" font-size="8.5" font-weight="700" fill="url(#accentGrad-dark)">LOC</text>
        <text x="590" y="258" font-family="'Inter',sans-serif" font-size="13" fill="#94A3B8">Location: <tspan fill="#F8FAFC" font-weight="600">Pune, Maharashtra, India</tspan></text>
      </g>
      <g opacity="0" transform="translate(-10,0)">
        ...
        <rect x="544" y="273" width="34" height="18" rx="5" fill="url(#accentGrad-dark)" opacity="0.16"/>
        <text x="561" y="286" text-anchor="middle" font-family="'JetBrains Mono',monospace" font-size="8.5" font-weight="700" fill="url(#accentGrad-dark)">EDU</text>
        <text x="590" y="287" font-family="'Inter',sans-serif" font-size="13" fill="#94A3B8">Education: <tspan fill="#F8FAFC" font-weight="600">B.E. Computer Science</tspan></text>
      </g>
      <g opacity="0" transform="translate(-10,0)">
        ...
        <rect x="544" y="302" width="34" height="18" rx="5" fill="url(#accentGrad-dark)" opacity="0.16"/>
        <text x="561" y="315" text-anchor="middle" font-family="'JetBrains Mono',monospace" font-size="8.5" font-weight="700" fill="url(#accentGrad-dark)">JOB</text>
        <text x="590" y="316" font-family="'Inter',sans-serif" font-size="13" fill="#94A3B8">Current Focus: <tspan fill="#F8FAFC" font-weight="600">Sr. Web Developer @ The Brand Bugzz</tspan></text>
      </g>
      <g opacity="0" transform="translate(-10,0)">
        ...
        <rect x="544" y="331" width="34" height="18" rx="5" fill="url(#accentGrad-dark)" opacity="0.16"/>
        <text x="561" y="344" text-anchor="middle" font-family="'JetBrains Mono',monospace" font-size="8.5" font-weight="700" fill="url(#accentGrad-dark)">PRJ</text>
        <text x="590" y="345" font-family="'Inter',sans-serif" font-size="13" fill="#94A3B8">Featured Projects: <tspan fill="#F8FAFC" font-weight="600">Erupaiya · TPM · HRMS · LMS</tspan></text>
      </g>
      <g opacity="0" transform="translate(-10,0)">
        ...
        <rect x="544" y="360" width="34" height="18" rx="5" fill="url(#accentGrad-dark)" opacity="0.16"/>
        <text x="561" y="373" text-anchor="middle" font-family="'JetBrains Mono',monospace" font-size="8.5" font-weight="700" fill="url(#accentGrad-dark)">WEB</text>
        <text x="590" y="374" font-family="'Inter',sans-serif" font-size="13" fill="#94A3B8">Portfolio: <tspan fill="#F8FAFC" font-weight="600">ketanpatil-phi.vercel.app</tspan></text>
      </g>
      <g opacity="0" transform="translate(-10,0)">
        ...
        <rect x="544" y="389" width="34" height="18" rx="5" fill="url(#accentGrad-dark)" opacity="0.16"/>
        <text x="561" y="402" text-anchor="middle" font-family="'JetBrains Mono',monospace" font-size="8.5" font-weight="700" fill="url(#accentGrad-dark)">MAIL</text>
        <text x="590" y="403" font-family="'Inter',sans-serif" font-size="13" fill="#94A3B8">Email: <tspan fill="#F8FAFC" font-weight="600">patilketan1303@gmail.com</tspan></text>
      </g>
      ...
      <g opacity="0" transform="scale(0.85)" style="transform-origin:512.1px 471.0px">
        ...
        <rect x="488" y="458" width="48.2" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="2.0s" repeatCount="indefinite"/>
        </rect>
        <text x="512.1" y="475.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">PHP</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:605.3000000000001px 471.0px">
        ...
        <rect x="544.2" y="458" width="122.2" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="2.35s" repeatCount="indefinite"/>
        </rect>
        <text x="605.3000000000001" y="475.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">CodeIgniter 4</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:717.0000000000001px 471.0px">
        ...
        <rect x="674.4000000000001" y="458" width="85.2" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="2.7s" repeatCount="indefinite"/>
        </rect>
        <text x="717.0000000000001" y="475.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">React.js</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:817.6000000000001px 471.0px">
        ...
        <rect x="767.6000000000001" y="458" width="100.0" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="3.05s" repeatCount="indefinite"/>
        </rect>
        <text x="817.6000000000001" y="475.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">TypeScript</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:925.6000000000001px 471.0px">
        ...
        <rect x="875.6000000000001" y="458" width="100.0" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="3.4s" repeatCount="indefinite"/>
        </rect>
        <text x="925.6000000000001" y="475.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">JavaScript</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:1015.1000000000001px 471.0px">
        ...
        <rect x="983.6000000000001" y="458" width="63.0" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="3.75s" repeatCount="indefinite"/>
        </rect>
        <text x="1015.1000000000001" y="475.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">MySQL</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:1093.5000000000002px 471.0px">
        ...
        <rect x="1054.6000000000001" y="458" width="77.8" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="4.1s" repeatCount="indefinite"/>
        </rect>
        <text x="1093.5000000000002" y="475.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">Node.js</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:519.5px 505.0px">
        ...
        <rect x="488" y="492" width="63.0" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="4.45s" repeatCount="indefinite"/>
        </rect>
        <text x="519.5" y="509.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">Redis</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:616.4px 505.0px">
        ...
        <rect x="559.0" y="492" width="114.8" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="4.8s" repeatCount="indefinite"/>
        </rect>
        <text x="616.4" y="509.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">Tailwind CSS</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:728.0999999999999px 505.0px">
        ...
        <rect x="681.8" y="492" width="92.6" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="5.15s" repeatCount="indefinite"/>
        </rect>
        <text x="728.0999999999999" y="509.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">WordPress</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:806.5px 505.0px">
        ...
        <rect x="782.4" y="492" width="48.2" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="5.5s" repeatCount="indefinite"/>
        </rect>
        <text x="806.5" y="509.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">Git</text>
      </g>
      <g opacity="0" transform="scale(0.85)" style="transform-origin:884.9px 505.0px">
        ...
        <rect x="838.6" y="492" width="92.6" height="26" rx="15" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.5" stroke-width="1">
          <animate attributeName="stroke-opacity" values="0.35;0.8;0.35" dur="3s" begin="5.85s" repeatCount="indefinite"/>
        </rect>
        <text x="884.9" y="509.0" text-anchor="middle" font-family="'Inter',sans-serif" font-size="11.5" font-weight="600" fill="#F8FAFC">REST APIs</text>
      </g>
      ...
      <g opacity="0" transform="translate(505,552)">
        ...
        <circle r="17" fill="#FFFFFF" fill-opacity="0.06" stroke="url(#accentGrad-dark)" stroke-opacity="0.45" stroke-width="1.2">
          <animate attributeName="stroke-opacity" values="0.3;0.85;0.3" dur="2.6s" begin="1.2s" repeatCount="indefinite"/>
        </circle>
        <g transform="scale(0.62)" fill="#F8FAFC">
  ...
  <rect x="1.5" y="1.5" width="1177" height="607" rx="24" fill="none" stroke="url(#borderGrad-dark)" stroke-width="2"/>
  <rect x="1.5" y="1.5" width="1177" height="607" rx="24" fill="none" stroke="#FFFFFF" stroke-opacity="0.08" stroke-width="1"/>
</svg>
